...
const contributors = [
  {
    ...
    role: "Machine Learning and Backend Developer",
    github: "De-Coder05",
    linkedin: "devansh-wadhwani",
    gradient: "from-blue-600 to-indigo-600",
    initials: "DW",
    img: "Devansh.png",
    expertise: ["Machine Learning", "Backend Development", "AI Models"]
  },
  {
    name: "Shreya Giri",
    role: "Frontend Developer & Researcher",
    github: "shreyagiri",
    linkedin: "shreya-giri",
    gradient: "from-purple-600 to-pink-600",
    initials: "SG",
    img: "Shreya.jpg",
    expertise: ["Frontend Development", "React", "Research"]
  },
];
  ...
  return (
    <section id="contributors" className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Contributors Grid */}
        <div className="contributors-grid mb-16">
          {/* Two Contributors */}
