    ...
    return (
      <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-700 mb-2">Running Deep Learning Models</h3>
          <p className="text-gray-500">Processing multimodal data through CNN-GRU-Attention, Ensemble Classifiers, and Late Fusion Architecture...</p>
        </CardContent>
      </Card>
    )
  }
      ...
      <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-500">
            Complete all three assessment methods to receive your detailed multimodal stress analysis powered by Deep Learning and Ensemble Methods.
          </p>
        </CardContent>
      </Card>
    )
      ...
      <Card className={`border-2 shadow-2xl ${getStressLevelColor(result.predictions.prediction_label)} bg-white/95 backdrop-blur-sm`}>
        <CardHeader className="text-center pb-4">
          <CardTitle className="text-2xl font-bold flex items-center justify-center gap-2">
            ...
            AI-Powered Stress Analysis Results
          </CardTitle>
        </CardHeader>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardHeader className="pb-3">
            ...
            <p className="text-xs text-gray-500 mt-1">Regularized Ensemble Classifier</p>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              {result.metadata.physio_windows} time-series windows | {result.metadata.physio_features} engineered features
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardHeader className="pb-3">
            ...
            <p className="text-xs text-gray-500 mt-1">Stacking Classifier Ensemble</p>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="space-y-2">
              {["Low", "Medium", "High"].map((level, index) => (
        ...
        <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardHeader className="pb-3">
            ...
            <p className="text-xs text-gray-500 mt-1">CNN-GRU-Attention Deep Learning</p>
          </CardHeader>
          <CardContent className="space-y-3">
      ...
      {result.explanations && (
        <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardHeader>
            ...
            <p className="text-xs text-gray-500 mt-1">SHAP Values | Feature Importance | Model Transparency</p>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* Fusion Explanation */}
            {result.explanations.fusion.available && (
              <div className="space-y-3">
                <h4 className="font-semibold text-lg">Late Fusion Architecture Analysis</h4>
                <p className="text-xs text-gray-500 mb-2">Multi-modal Integration | Weighted Ensemble Fusion</p>
            ...
            {result.explanations.physiological.available && result.explanations.physiological.feature_importance.length > 0 && (
              <div className="space-y-3">
                <h4 className="font-semibold text-lg">Key Physiological Features (SHAP Analysis)</h4>
                <p className="text-xs text-gray-500 mb-2">Feature Engineering: Time-domain, Frequency-domain, Wavelet Transform</p>
                <p className="text-gray-700 bg-gray-50 p-3 rounded-lg">
            ...
            {result.explanations.questionnaire.available && result.explanations.questionnaire.feature_importance.length > 0 && (
              <div className="space-y-3">
                <h4 className="font-semibold text-lg">Questionnaire Feature Importance</h4>
                <p className="text-xs text-gray-500 mb-2">Stacking Classifier Feature Analysis</p>
                <p className="text-gray-700 bg-gray-50 p-3 rounded-lg">
            ...
            {result.explanations.voice.available && result.explanations.voice.feature_importance.length > 0 && (
              <div className="space-y-3">
                <h4 className="font-semibold text-lg">Deep Learning Voice Analysis Insights</h4>
                <p className="text-xs text-gray-500 mb-2">CNN-GRU-Attention Model | MFCC Feature Extraction</p>
                <p className="text-gray-700 bg-gray-50 p-3 rounded-lg">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Engineered Features:</span>
                <span className="font-medium">{result.metadata.physio_features} (Feature Engineering)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Multi-modal Fusion:</span>
                <span className="font-medium">{result.metadata.modalities_used.filter(Boolean).join(", ")}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">ML Architecture:</span>
                <span className="font-medium">Late Fusion | Ensemble Learning</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
